...
import {
    ...
    RelationTypeEnum, RelationUpdatePayload,
...
export class RelationsService {
    ...
    public async updateRelation(userId: User['id'], relationId: Relation['id'], relation: RelationUpdatePayload): Promise<Relation> {
        const { relation_types, ...relationData } = relation;
